...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<VwTheBestCustomer> VwTheBestCustomers { get; set; }

    public virtual DbSet<VwYearQuantityTotal> VwYearQuantityTotals { get; set; }

    public virtual DbSet<VwYearQuantityTotal1> VwYearQuantityTotal1s { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwTheBestCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_TheBestCustomer");
        ...
        modelBuilder.Entity<VwYearQuantityTotal>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_YearQuantityTotal");

            entity.Property(e => e.TotalSales).HasColumnType("money");
        });

        modelBuilder.Entity<VwYearQuantityTotal1>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_YearQuantityTotal1");

            entity.Property(e => e.SalesYear).HasColumnType("datetime");
        });
